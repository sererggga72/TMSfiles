...
// @description Торрент трекер tfile.cc - фильмы, музыка, программы, книги.
...
API_exKit({
    ...
    title: 'TFile',
    icon: 'data:image/x-icon;base64,',
    desc: 'Торрент трекер tfile.cc - фильмы, музыка, программы, книги.',
    flags: {
        auth: 0,
        language: 'ru',
        cyrillic: 1
    ...
    search: {
        loginUrl: 'http://tfile.cc',
        searchUrl: 'http://tfile.cc/forum/ssearch.php',
        nextPageSelector: {selector: '.pagination a.next', attr: 'href'},
        baseUrl: 'http://tfile.cc/forum/',
        requestType: 'GET',
